...
public class SimpleCapsuleWithStickMovement : MonoBehaviour
{
    ...
    public float ContinuousRotationSpeed = 30.0f;
    public bool UseContinuousRotation = true; // Toggle between snap and continuous rotation
    ...
    void ContinuousTurn()
    {
        ...
        float rotationAmount = horizontalInput * ContinuousRotationSpeed * Time.deltaTime;
